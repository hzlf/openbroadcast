...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Audio.tracknumber'
        db.delete_column('filer_audio', 'tracknumber')

        # Deleting field 'Audio.license'
        db.delete_column('filer_audio', 'license_id')

        # Deleting field 'Audio.artist'
        db.delete_column('filer_audio', 'artist_id')


    def backwards(self, orm):
        
        # Adding field 'Audio.tracknumber'
