...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Audio.bits_per_sample'
        db.add_column('filer_audio', 'bits_per_sample',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Audio.sample_rate'
        db.add_column('filer_audio', 'sample_rate',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Audio.total_frames'
        db.add_column('filer_audio', 'total_frames',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Audio.seconds_length'
        db.add_column('filer_audio', 'seconds_length',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Audio.bits_per_sample'
        db.delete_column('filer_audio', 'bits_per_sample')

        # Deleting field 'Audio.sample_rate'
        db.delete_column('filer_audio', 'sample_rate')

        # Deleting field 'Audio.total_frames'
        db.delete_column('filer_audio', 'total_frames')

        # Deleting field 'Audio.seconds_length'
        db.delete_column('filer_audio', 'seconds_length')
