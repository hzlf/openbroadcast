...
base.ui.iface = function() {
	...
	*/
	...
	// for single elements (through href/class)
	$('.collectable').live('click', function() {
	...
	*/
	...
	/*
	 * Maybe not the final place, but as there are only a bunch of such functions
...
base.ui.downloads_update = function() {
	$('.mp-list').load('/ajax/downloads_list');
	setTimeout("base.ui.downloads_update()", 15000);
};
