...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invite_invite', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'invites', to=orm['auth.User'])),
    ...
    models = {
        ...
        'invite.invite': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'invites'", 'to': "orm['auth.User']"})
        }
    }
