...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alibrary_media', 'folder',
                      self.gf('django.db.models.fields.CharField')(default='/Users/ohrstrom/Documents/Code/openbroadcast.ch/website/media/private/', max_length=1024, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.media': {
            ...
            'folder': ('django.db.models.fields.CharField', [], {'default': "'/Users/ohrstrom/Documents/Code/openbroadcast.ch/website/media/private/'", 'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
