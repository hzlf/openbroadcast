...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alibrary_label', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(default='483ae911-cc95-4dbf-8661-ecd9baf91274', max_length=36)),
        ...
        db.create_table('alibrary_license', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=100)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='7f34342c-a29a-4245-8fe7-2d71bea295fd', max_length=36)),
        ...
        db.create_table('alibrary_release', (
            ...
            ('label', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_label', to=orm['alibrary.Label'])),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_folder', null=True, to=orm['filer.Folder'])),
        ...
        db.create_table('alibrary_artist', (
            ...
            ('placeholder_1', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True)),
            ('multiple', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
    ...
    models = {
        ...
        'alibrary.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'483ae911-cc95-4dbf-8661-ecd9baf91274'", 'max_length': '36'})
        },
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7f34342c-a29a-4245-8fe7-2d71bea295fd'", 'max_length': '36'})
        },
        'alibrary.media': {
