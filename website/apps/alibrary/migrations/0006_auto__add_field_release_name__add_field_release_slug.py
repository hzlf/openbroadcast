...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alibrary_release', 'name',
                      self.gf('django.db.models.fields.CharField')(default='newname', max_length=200),
                      keep_default=False)

        # Adding field 'Release.slug'
        db.add_column('alibrary_release', 'slug',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('alibrary_release', 'name')

        # Deleting field 'Release.slug'
        db.delete_column('alibrary_release', 'slug')
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a7baa963-a90d-4621-8876-5b703a471b8d'", 'max_length': '36'})
        },
        'alibrary.media': {
