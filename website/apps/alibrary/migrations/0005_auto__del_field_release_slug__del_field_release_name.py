...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('alibrary_release', 'name',
                      self.gf('django.db.models.fields.CharField')(default='deleted', max_length=200),
                      keep_default=False)
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8aa72a9a-1847-4abe-9c49-b771da12bc87'", 'max_length': '36'})
        },
        'alibrary.media': {
