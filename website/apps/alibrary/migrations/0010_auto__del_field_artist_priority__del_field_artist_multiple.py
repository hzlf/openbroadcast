...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('alibrary_artist', 'priority')

        # Deleting field 'Artist.multiple'
        db.delete_column('alibrary_artist', 'multiple')


    def backwards(self, orm):
        # Adding field 'Artist.priority'
        db.add_column('alibrary_artist', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Artist.multiple'
        db.add_column('alibrary_artist', 'multiple',
    ...
    models = {
        ...
        'alibrary.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'dd5df3ac-6c76-49eb-9db8-191a0dcb51e3'", 'max_length': '36'})
        },
        'alibrary.media': {
