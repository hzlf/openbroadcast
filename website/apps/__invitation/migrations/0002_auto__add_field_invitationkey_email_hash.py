...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvitationKey.email_hash'
        db.add_column('invitation_invitationkey', 'email_hash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvitationKey.email_hash'
        db.delete_column('invitation_invitationkey', 'email_hash')
    ...
    models = {
        ...
        'invitation.invitationkey': {
            ...
            'date_invited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 13, 0, 0)'}),
