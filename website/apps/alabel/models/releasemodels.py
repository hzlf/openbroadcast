...
from alabel.models.artistmodels import *
...
class Release(models.Model):
    ...
    # relations
    label = models.ForeignKey(Label, related_name='release_label')
    folder = models.ForeignKey(Folder, blank=True, null=True, related_name='release_folder')
    ...
    def build_cache_file(self, format, version):
        ...
        for media in self.get_media():
            ...
            # archive_file.write('/Users/ohrstrom/code/alabel/website/check.txt', 'test.txt')
