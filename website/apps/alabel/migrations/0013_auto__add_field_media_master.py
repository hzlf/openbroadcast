...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alabel_media', 'master', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_master', null=True, to=orm['filer.Audio']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Media.master'
        db.delete_column('alabel_media', 'master_id')
