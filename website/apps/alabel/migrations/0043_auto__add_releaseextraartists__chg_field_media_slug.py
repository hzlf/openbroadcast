...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alabel_releaseextraartists', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_extraartist_artist', to=orm['alabel.Artist'])),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_extraartist_release', to=orm['alabel.Release'])),
            ('profession', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_extraartist_profession', null=True, to=orm['alabel.Profession'])),
        ))
        db.send_create_signal('alabel', ['ReleaseExtraartists'])

        # Changing field 'Media.slug'
        db.alter_column('alabel_media', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting model 'ReleaseExtraartists'
        db.delete_table('alabel_releaseextraartists')

        # Changing field 'Media.slug'
        db.alter_column('alabel_media', 'slug', self.gf('django.db.models.fields.SlugField')(default='mydaslug', max_length=100))
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'24d7f3b9-0b84-42ea-b91b-699c9d848f53'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'344d0e93-8e9d-4c78-bfe7-1ec917ee306c'", 'max_length': '36'})
        },
        'alabel.media': {
        ...
        'alabel.release': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'excerpt': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'extra_artists': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['alabel.Profession']", 'null': 'True', 'through': "orm['alabel.ReleaseExtraartists']", 'blank': 'True'}),
