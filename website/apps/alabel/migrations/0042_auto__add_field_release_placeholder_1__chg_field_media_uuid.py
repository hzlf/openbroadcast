...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alabel_release', 'placeholder_1', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True), keep_default=False)

        # Changing field 'Media.uuid'
        db.alter_column('alabel_media', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Release.placeholder_1'
        db.delete_column('alabel_release', 'placeholder_1_id')

        # Changing field 'Media.uuid'
        db.alter_column('alabel_media', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=36))
    ...
    models = {
        'alabel.artist': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1ae5574f-70c9-4ffe-9e45-018ba2019eef'", 'max_length': '36'})
        },
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d54403fe-84bc-4fdd-9d52-dd3020209846'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fe8581e1-9f9a-491a-991e-660e849d7710'", 'max_length': '36'})
        },
        'alabel.media': {
        ...
        'alabel.playlist': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b626c5b0-3a6e-4a8c-9274-b8fd410e4cb2'", 'max_length': '36'})
        },
        ...
        'alabel.release': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'105f2845-a073-4aa5-b546-1aea177b3238'", 'max_length': '36'})
        },
        'auth.group': {
