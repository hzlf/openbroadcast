...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Artist.listed'
        db.alter_column('alabel_artist', 'listed', self.gf('django.db.models.fields.BooleanField')())
    def backwards(self, orm):

        # Changing field 'Artist.listed'
        db.alter_column('alabel_artist', 'listed', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    models = {
        'alabel.artist': {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b3409538-23bd-4298-9056-9fcb264a11a7'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a5891f68-2492-4e64-be01-1e80263ed773'", 'max_length': '36'})
        },
        'alabel.media': {
