...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('alabel_release', 'product', self.gf('django.db.models.fields.related.OneToOneField')(related_name='release_product', unique=True, null=True, to=orm['ashop.Baseproduct'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7d1af567-dab2-44a8-b08e-799c9a47b800'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'773c0e19-5405-4ca6-85cb-8182bc8ed03d'", 'max_length': '36'})
        },
        'alabel.media': {
