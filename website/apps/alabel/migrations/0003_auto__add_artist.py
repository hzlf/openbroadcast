...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alabel_artist', (
            ...
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='artist_folder', null=True, to=orm['filer.Folder'])),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('alabel', ['Artist'])


    def backwards(self, orm):
        
        # Deleting model 'Artist'
        db.delete_table('alabel_artist')
