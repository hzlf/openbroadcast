...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alabel_release', 'slug', self.gf('django.db.models.fields.SlugField')(default='release-slug', max_length=100, db_index=True), keep_default=False)

        # Adding field 'Release.main_image'
        db.add_column('alabel_release', 'main_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_main_image', null=True, to=orm['filer.Image']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Release.slug'
        db.delete_column('alabel_release', 'slug')

        # Deleting field 'Release.main_image'
        db.delete_column('alabel_release', 'main_image_id')
