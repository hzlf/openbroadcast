...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Media.artist'
        db.add_column('alabel_media', 'artist', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_artist', null=True, to=orm['alabel.Artist']), keep_default=False)

        # Adding field 'Media.license'
        db.add_column('alabel_media', 'license', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_license', null=True, to=orm['alabel.License']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Media.artist'
        db.delete_column('alabel_media', 'artist_id')

        # Deleting field 'Media.license'
        db.delete_column('alabel_media', 'license_id')
