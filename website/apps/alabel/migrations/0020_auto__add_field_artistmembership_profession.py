...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ArtistMembership.profession'
        db.add_column('alabel_artistmembership', 'profession', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='artist_membership_profession', null=True, to=orm['alabel.Profession']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ArtistMembership.profession'
        db.delete_column('alabel_artistmembership', 'profession_id')
