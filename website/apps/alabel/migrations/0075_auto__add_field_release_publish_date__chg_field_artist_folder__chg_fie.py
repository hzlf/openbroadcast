...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alabel_release', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Artist.folder'
        db.alter_column('alabel_artist', 'folder_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['filer.Folder']))

        # Changing field 'Media.release'
        db.alter_column('alabel_media', 'release_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['alabel.Release']))

        # Changing field 'Media.folder'
        db.alter_column('alabel_media', 'folder_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['filer.Folder']))
    def backwards(self, orm):
        # Deleting field 'Release.publish_date'
        db.delete_column('alabel_release', 'publish_date')


        # Changing field 'Artist.folder'
        db.alter_column('alabel_artist', 'folder_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['filer.Folder']))
        ...
        # Changing field 'Media.folder'
        db.alter_column('alabel_media', 'folder_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['filer.Folder']))
    models = {
        'alabel.artist': {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'287bac84-fd17-4691-8134-bd32d4b64c93'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'89c08ce5-ab26-4480-85f6-1205429f822b'", 'max_length': '36'})
        },
        'alabel.media': {
            ...
            'release': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'media_release'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['alabel.Release']"}),
