...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Media'
        db.create_table('alabel_media', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('tracknumber', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12)),
            ('mediatype', self.gf('django.db.models.fields.CharField')(default='other', max_length=12)),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(related_name='media_release', to=orm['alabel.Release'])),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('alabel', ['Media'])


    def backwards(self, orm):
        
        # Deleting model 'Media'
        db.delete_table('alabel_media')
