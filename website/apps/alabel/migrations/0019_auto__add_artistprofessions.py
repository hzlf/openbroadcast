...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alabel_artistprofessions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alabel.Artist'])),
            ('profession', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alabel.Profession'])),
        ))
        db.send_create_signal('alabel', ['ArtistProfessions'])

        # Removing M2M table for field professions on 'Artist'
        db.delete_table('alabel_artist_professions')


    def backwards(self, orm):
        
        # Deleting model 'ArtistProfessions'
        db.delete_table('alabel_artistprofessions')

        # Adding M2M table for field professions on 'Artist'
        db.create_table('alabel_artist_professions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('artist', models.ForeignKey(orm['alabel.artist'], null=False)),
            ('profession', models.ForeignKey(orm['alabel.profession'], null=False))
        ))
        db.create_unique('alabel_artist_professions', ['artist_id', 'profession_id'])
