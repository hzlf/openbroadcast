...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alabel_release', 'product', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='release_product', unique=True, null=True, to=orm['ashop.Baseproduct']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Release.product'
        db.delete_column('alabel_release', 'product_id')
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'66ff5565-9f5d-4734-b018-6f367b308fb4'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'36c13934-1dd4-462c-ae84-3073c621de3c'", 'max_length': '36'})
        },
        'alabel.media': {
        ...
        'alabel.release': {
            ...
            'product': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'release_product'", 'unique': 'True', 'null': 'True', 'to': "orm['ashop.Baseproduct']"}),
