...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Release.uuid'
        db.add_column('alabel_release', 'uuid', self.gf('django.db.models.fields.CharField')(default='5b24a613-83e5-4120-8145-d8c46bf0030a', max_length=36), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Release.uuid'
        db.delete_column('alabel_release', 'uuid')
    ...
    models = {
        ...
        'alabel.release': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5b24a613-83e5-4120-8145-d8c46bf0030a'", 'max_length': '36'})
        },
        'auth.group': {
