...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field relations on 'Release'
        db.create_table('alabel_release_relations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('release', models.ForeignKey(orm['alabel.release'], null=False)),
            ('relation', models.ForeignKey(orm['alabel.relation'], null=False))
        ))
        db.create_unique('alabel_release_relations', ['release_id', 'relation_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field relations on 'Release'
        db.delete_table('alabel_release_relations')
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c57783bd-8c6e-4335-bd06-7c0b40398299'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1e55d46d-635a-4874-968a-93089e6dfd8d'", 'max_length': '36'})
        },
        'alabel.media': {
        ...
        'alabel.release': {
            ...
            'relations': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['alabel.Relation']", 'symmetrical': 'False'}),
