...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'License', fields ['uuid']
        db.delete_unique('alabel_license', ['uuid'])

        # Removing unique constraint on 'Media', fields ['uuid']
        db.delete_unique('alabel_media', ['uuid'])

        # Removing unique constraint on 'Label', fields ['uuid']
        db.delete_unique('alabel_label', ['uuid'])

        # Removing unique constraint on 'Artist', fields ['uuid']
        db.delete_unique('alabel_artist', ['uuid'])

        # Adding model 'PlaylistMedia'
        db.create_table('alabel_playlistmedia', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('playlist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playlist_playlist', to=orm['alabel.Artist'])),
            ('media', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playlist_media', to=orm['alabel.Media'])),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=12)),
        ))
        db.send_create_signal('alabel', ['PlaylistMedia'])

        # Adding model 'Playlist'
        db.create_table('alabel_playlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=100, db_index=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='31856fff-7fa2-4de5-910c-1935c9bdbd0f', max_length=36)),
        ...
        db.send_create_signal('alabel', ['Playlist'])


    def backwards(self, orm):
        
        # Deleting model 'PlaylistMedia'
        db.delete_table('alabel_playlistmedia')

        # Deleting model 'Playlist'
        db.delete_table('alabel_playlist')

        # Adding unique constraint on 'Artist', fields ['uuid']
        db.create_unique('alabel_artist', ['uuid'])

        # Adding unique constraint on 'Label', fields ['uuid']
        db.create_unique('alabel_label', ['uuid'])

        # Adding unique constraint on 'Media', fields ['uuid']
        db.create_unique('alabel_media', ['uuid'])

        # Adding unique constraint on 'License', fields ['uuid']
        db.create_unique('alabel_license', ['uuid'])
    ...
    models = {
        'alabel.artist': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1d079043-10d4-4bb7-a0b7-57eb076c2c2c'", 'max_length': '36'})
        },
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'56ceba1d-dc7e-4219-be1a-b610e9bf28bc'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'88996c49-274c-4bcd-bfab-d47661a9d1cb'", 'max_length': '36'})
        },
        'alabel.media': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fd54c702-b906-4ac0-848c-9531fb924a54'", 'max_length': '36'})
        },
        ...
        'alabel.playlist': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'31856fff-7fa2-4de5-910c-1935c9bdbd0f'", 'max_length': '36'})
        },
        'alabel.playlistmedia': {
            ...
            'playlist': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'playlist_playlist'", 'to': "orm['alabel.Artist']"}),
        ...
        'alabel.release': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'54daa102-c47e-4119-92f2-6231393a02cb'", 'max_length': '36'})
        },
        'auth.group': {
