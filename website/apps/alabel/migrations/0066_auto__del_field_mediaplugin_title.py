...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MediaPlugin.title'
        db.delete_column('cmsplugin_mediaplugin', 'title')


    def backwards(self, orm):
        
        # Adding field 'MediaPlugin.title'
        db.add_column('cmsplugin_mediaplugin', 'title', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'520c4f35-2ccd-4730-a861-05b586e6322d'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'056a07d6-c038-4117-b2ec-91301a718346'", 'max_length': '36'})
        },
        'alabel.media': {
