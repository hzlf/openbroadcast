...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field memberships on 'Artist'
        db.create_table('alabel_artist_memberships', (
        ...
        db.create_unique('alabel_artist_memberships', ['from_artist_id', 'to_artist_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field memberships on 'Artist'
        db.delete_table('alabel_artist_memberships')
    ...
    models = {
        'alabel.artist': {
            ...
            'memberships': ('mptt.fields.TreeManyToManyField', [], {'blank': 'True', 'related_name': "'memberships_rel_+'", 'null': 'True', 'to': "orm['alabel.Artist']"}),
