...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlaylistMedia.playlist'
        db.alter_column('alabel_playlistmedia', 'playlist_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alabel.Playlist']))


    def backwards(self, orm):
        
        # Changing field 'PlaylistMedia.playlist'
        db.alter_column('alabel_playlistmedia', 'playlist_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alabel.Artist']))
    ...
    models = {
        'alabel.artist': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'03878334-7a77-4f46-9828-56fe4bbe9e56'", 'max_length': '36'})
        },
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'95f0089d-1560-4b26-ac12-c2252f88fe05'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ae777e35-16af-4def-af81-508521b2f078'", 'max_length': '36'})
        },
        'alabel.media': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1518bede-611e-4939-aae5-a9149768f942'", 'max_length': '36'})
        },
        ...
        'alabel.playlist': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'65212282-ecb7-48ac-ad40-e6961fd106e6'", 'max_length': '36'})
        },
        ...
        'alabel.release': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'51ae5de3-0e34-4418-9f6e-1328b5fb0c08'", 'max_length': '36'})
        },
        'auth.group': {
