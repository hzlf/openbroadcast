...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Artist.real_x_name'
        db.add_column('alabel_artist', 'real_x_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Artist.real_x_name'
        db.delete_column('alabel_artist', 'real_x_name')
    ...
    models = {
        'alabel.artist': {
            ...
            'real_x_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
