...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alabel_artist', 'slug', self.gf('django.db.models.fields.SlugField')(default='empty-slug', max_length=100, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Artist.slug'
        db.delete_column('alabel_artist', 'slug')
