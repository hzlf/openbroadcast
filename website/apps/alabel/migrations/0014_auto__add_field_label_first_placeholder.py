...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alabel_label', 'first_placeholder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Label.first_placeholder'
        db.delete_column('alabel_label', 'first_placeholder_id')
