...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.cover_image'
        db.add_column('alabel_release', 'cover_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_cover_image', null=True, to=orm['filer.Image']),
                      keep_default=False)

        # Adding field 'Release.format_text'
        db.add_column('alabel_release', 'format_text',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Release.cover_image'
        db.delete_column('alabel_release', 'cover_image_id')

        # Deleting field 'Release.format_text'
        db.delete_column('alabel_release', 'format_text')
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'48aa4a5c-984e-43a0-9737-a47a92050f28'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9d733d9c-299e-456b-843e-1bad1c3aafff'", 'max_length': '36'})
        },
        'alabel.media': {
        ...
        'alabel.release': {
            ...
            'format_text': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
