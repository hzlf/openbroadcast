...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Relation.content_type'
        db.add_column('alabel_relation', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'Relation.object_id'
        db.add_column('alabel_relation', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Relation.content_type'
        db.delete_column('alabel_relation', 'content_type_id')

        # Deleting field 'Relation.object_id'
        db.delete_column('alabel_relation', 'object_id')
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4e1db652-654b-487a-a27d-2dfe07ed00dd'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'39cf5e72-6aba-433c-a0bf-ee5779019b85'", 'max_length': '36'})
        },
        'alabel.media': {
