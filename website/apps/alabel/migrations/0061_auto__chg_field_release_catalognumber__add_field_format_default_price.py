...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Release.catalognumber'
        db.alter_column('alabel_release', 'catalognumber', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Adding field 'Format.default_price'
        db.add_column('alabel_format', 'default_price', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, max_length=6, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Release.catalognumber'
        db.alter_column('alabel_release', 'catalognumber', self.gf('django.db.models.fields.CharField')(default=1, max_length=50))

        # Deleting field 'Format.default_price'
        db.delete_column('alabel_format', 'default_price')
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f9612180-72fb-4432-9baf-c1116accab1d'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cd2e79ac-823f-40e1-8829-d84eb6dc27a0'", 'max_length': '36'})
        },
        'alabel.media': {
