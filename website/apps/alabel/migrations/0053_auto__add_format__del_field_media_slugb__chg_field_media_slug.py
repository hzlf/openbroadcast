...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('alabel', ['Format'])

        # Deleting field 'Media.slugb'
        db.delete_column('alabel_media', 'slugb')

        # Changing field 'Media.slug'
        db.alter_column('alabel_media', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', default='', populate_from='name', overwrite=False))


    def backwards(self, orm):
        
        # Deleting model 'Format'
        db.delete_table('alabel_format')

        # Adding field 'Media.slugb'
        db.add_column('alabel_media', 'slugb', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, null=True, populate_from='name', overwrite=False, db_index=True), keep_default=False)
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1e84337a-f255-4449-bd44-8a3e83565333'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'69d25b5d-460d-487b-a071-8e13aebd6df5'", 'max_length': '36'})
        },
        'alabel.media': {
