...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.enable_comments'
        db.add_column('alabel_release', 'enable_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Artist.enable_comments'
        db.add_column('alabel_artist', 'enable_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Release.enable_comments'
        db.delete_column('alabel_release', 'enable_comments')

        # Deleting field 'Artist.enable_comments'
        db.delete_column('alabel_artist', 'enable_comments')
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'82d00db8-3fc8-4d4a-9cb5-3906e2572047'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'56f26d7f-85a0-4757-b32a-e8daa542752a'", 'max_length': '36'})
        },
        'alabel.media': {
