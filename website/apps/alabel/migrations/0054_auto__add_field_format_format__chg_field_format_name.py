...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Format.format'
        db.add_column('alabel_format', 'format', self.gf('django.db.models.fields.CharField')(default=0, max_length=4), keep_default=False)

        # Changing field 'Format.name'
        db.alter_column('alabel_format', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Deleting field 'Format.format'
        db.delete_column('alabel_format', 'format')

        # Changing field 'Format.name'
        db.alter_column('alabel_format', 'name', self.gf('django.db.models.fields.CharField')(max_length=4))
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'14651767-68b0-4612-b3c1-23ed91fd64e5'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'762618c1-d010-4722-a38e-aa45d5619f82'", 'max_length': '36'})
        },
        'alabel.media': {
