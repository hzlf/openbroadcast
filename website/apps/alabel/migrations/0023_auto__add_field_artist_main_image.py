...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alabel_artist', 'main_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='artist_main_image', null=True, to=orm['filer.Image']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Artist.main_image'
        db.delete_column('alabel_artist', 'main_image_id')
