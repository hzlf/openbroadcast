...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alabel_profession', (
        ...
        db.send_create_signal('alabel', ['Profession'])
        ...
        # db.create_table('alabel_artist', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Artist', fields ['slug']
        db.delete_unique('alabel_artist', ['slug'])

        # Deleting model 'Profession'
        db.delete_table('alabel_profession')
    ...
    models = {
        'alabel.artist': {
            ...
            'professions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['alabel.Profession']", 'symmetrical': 'False'}),
