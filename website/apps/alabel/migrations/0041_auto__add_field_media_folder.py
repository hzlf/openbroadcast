...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('alabel_media', 'folder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_folder', null=True, to=orm['filer.Folder']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Media.folder'
        db.delete_column('alabel_media', 'folder_id')
    ...
    models = {
        'alabel.artist': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'163b7fec-311a-4dfe-a5fe-3d994df77702'", 'max_length': '36'})
        },
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a5340fe4-3e40-41c3-b589-a6254a24596d'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e7df1794-d80a-4a71-a292-490b7a797447'", 'max_length': '36'})
        },
        'alabel.media': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ec9becdc-4985-4c98-8e35-bfd41aa40882'", 'max_length': '36'})
        },
        ...
        'alabel.playlist': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'55ec469d-2304-46cd-833c-13d7cda589ef'", 'max_length': '36'})
        },
        ...
        'alabel.release': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a0deb01c-6c9f-497c-8796-6e6cdaced424'", 'max_length': '36'})
        },
        'auth.group': {
