...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profession.in_listing'
        db.alter_column('alabel_profession', 'in_listing', self.gf('django.db.models.fields.BooleanField')())


    def backwards(self, orm):
        
        # Changing field 'Profession.in_listing'
        db.alter_column('alabel_profession', 'in_listing', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'17559377-0d2b-475e-a944-b0a9ae78035a'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'843f5618-6e57-4770-9b54-1e815339cd9f'", 'max_length': '36'})
        },
        'alabel.media': {
