...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Media.processed'
        db.add_column('alabel_media', 'processed', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=2), keep_default=False)

        # Adding field 'Media.lock'
        db.add_column('alabel_media', 'lock', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Media.processed'
        db.delete_column('alabel_media', 'processed')

        # Deleting field 'Media.lock'
        db.delete_column('alabel_media', 'lock')
    ...
    models = {
        'alabel.artist': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2b02fec1-bd1d-49c2-a94c-18e912cb8b15'", 'max_length': '36'})
        },
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5aac327c-5bd1-4f63-beab-5c7e5359f369'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3bb50d42-e78a-48aa-adbc-bbb73c07cd4d'", 'max_length': '36'})
        },
        'alabel.media': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6ddccda0-1511-4bda-b1e8-4471ee03a531'", 'max_length': '36'})
        },
        ...
        'alabel.playlist': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'310c812b-f9d6-49ec-bdc4-37749313815b'", 'max_length': '36'})
        },
        ...
        'alabel.release': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5dc0b82a-a5c3-4395-b91e-814f734cd8ec'", 'max_length': '36'})
        },
        'auth.group': {
