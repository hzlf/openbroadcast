...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Artist.uuid'
        db.add_column('alabel_artist', 'uuid', self.gf('django.db.models.fields.CharField')(default='a5c797d6-b77f-4621-abbf-b23063f6fd2a', unique=False, max_length=36), keep_default=False)

        # Adding field 'Label.slug'
        db.add_column('alabel_label', 'slug', self.gf('django.db.models.fields.SlugField')(default='label-slug', max_length=100, db_index=True), keep_default=False)

        # Adding field 'Label.uuid'
        db.add_column('alabel_label', 'uuid', self.gf('django.db.models.fields.CharField')(default='a444c1bc-68ae-420f-9795-5f417b82ce29', unique=False, max_length=36), keep_default=False)

        # Adding field 'Media.slug'
        db.add_column('alabel_media', 'slug', self.gf('django.db.models.fields.SlugField')(default='labe\xc3\xb6-slug', max_length=100, db_index=True), keep_default=False)

        # Adding field 'Media.uuid'
        db.add_column('alabel_media', 'uuid', self.gf('django.db.models.fields.CharField')(default='b789134d-6d2f-4a99-89e3-f4a6d6c4e59c', unique=False, max_length=36), keep_default=False)

        # Adding field 'License.slug'
        db.add_column('alabel_license', 'slug', self.gf('django.db.models.fields.SlugField')(default='ma-slag', max_length=100, db_index=True), keep_default=False)

        # Adding field 'License.uuid'
        db.add_column('alabel_license', 'uuid', self.gf('django.db.models.fields.CharField')(default='b0e0ce0a-e9c1-445f-8500-93a2f02c0908', unique=False, max_length=36), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Artist.uuid'
        db.delete_column('alabel_artist', 'uuid')

        # Deleting field 'Label.slug'
        db.delete_column('alabel_label', 'slug')

        # Deleting field 'Label.uuid'
        db.delete_column('alabel_label', 'uuid')

        # Deleting field 'Media.slug'
        db.delete_column('alabel_media', 'slug')

        # Deleting field 'Media.uuid'
        db.delete_column('alabel_media', 'uuid')

        # Deleting field 'License.slug'
        db.delete_column('alabel_license', 'slug')

        # Deleting field 'License.uuid'
        db.delete_column('alabel_license', 'uuid')
    ...
    models = {
        'alabel.artist': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a5c797d6-b77f-4621-abbf-b23063f6fd2a'", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a444c1bc-68ae-420f-9795-5f417b82ce29'", 'unique': 'True', 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b0e0ce0a-e9c1-445f-8500-93a2f02c0908'", 'unique': 'True', 'max_length': '36'})
        },
        'alabel.media': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b789134d-6d2f-4a99-89e3-f4a6d6c4e59c'", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'alabel.release': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4a3f5093-deaa-414f-bf1b-e19c9855a07d'", 'max_length': '36'})
        },
        'auth.group': {
