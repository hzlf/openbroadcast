...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Label.parent'
        db.add_column('alabel_label', 'parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='label_children', null=True, to=orm['alabel.Label']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Label.parent'
        db.delete_column('alabel_label', 'parent_id')
