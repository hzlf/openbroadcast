...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alabel_relation', (
        ...
        db.send_create_signal('alabel', ['Relation'])

        # Adding model 'ReleaseRelations'
        db.create_table('alabel_releaserelations', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('relation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_relation_relation', to=orm['alabel.Relation'])),
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_relation_release', to=orm['alabel.Release'])),
        ))
        db.send_create_signal('alabel', ['ReleaseRelations'])


    def backwards(self, orm):
        
        # Deleting model 'Relation'
        db.delete_table('alabel_relation')

        # Deleting model 'ReleaseRelations'
        db.delete_table('alabel_releaserelations')
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'dbc6e4ce-d258-45bd-8d7e-7b80755cbdf8'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'187fcc47-d8ea-4ad1-b450-b549a101dac2'", 'max_length': '36'})
        },
        'alabel.media': {
        ...
        'alabel.release': {
            ...
            'relations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['alabel.Relation']", 'null': 'True', 'through': "orm['alabel.ReleaseRelations']", 'blank': 'True'}),
