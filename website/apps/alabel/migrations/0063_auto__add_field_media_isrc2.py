...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Media.isrc2'
        db.add_column('alabel_media', 'isrc2', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Media.isrc2'
        db.delete_column('alabel_media', 'isrc2')
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bd8c1bec-2d70-420b-a6d4-963c87b25dfd'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1a8995e6-78a1-470d-8906-fd8ef5ad9154'", 'max_length': '36'})
        },
        'alabel.media': {
            ...
            'isrc2': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
