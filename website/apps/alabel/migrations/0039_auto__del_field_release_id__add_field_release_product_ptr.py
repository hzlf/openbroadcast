...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Release.id'
        db.delete_column('alabel_release', 'id')

        # Adding field 'Release.product_ptr'
        db.add_column('alabel_release', 'product_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['shop.Product'], unique=True, primary_key=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Release.id'
        db.add_column('alabel_release', 'id', self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True), keep_default=False)

        # Deleting field 'Release.product_ptr'
        db.delete_column('alabel_release', 'product_ptr_id')
    ...
    models = {
        'alabel.artist': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7ee6a5a4-f965-4389-a11b-ec61dff30273'", 'max_length': '36'})
        },
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ae279d63-9782-42a4-af21-e94a3db6e611'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bff014e3-ff14-4ed3-940b-25dcc7eb5b00'", 'max_length': '36'})
        },
        'alabel.media': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7ed53e5b-6039-4342-bb93-b8dc578987b7'", 'max_length': '36'})
        },
        ...
        'alabel.playlist': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'57f55057-8706-42c7-9f64-d6c6da0b111e'", 'max_length': '36'})
        },
        ...
        'alabel.release': {
            'Meta': {'ordering': "('releasedate',)", 'object_name': 'Release', '_ormbases': ['shop.Product']},
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c9e27f94-aa99-43fe-b482-c6ad088705d3'", 'max_length': '36'})
        },
        'auth.group': {
