...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Label.folder'
        db.add_column('alabel_label', 'folder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='label_folder', null=True, to=orm['filer.Folder']), keep_default=False)

        # Adding field 'Release.folder'
        db.add_column('alabel_release', 'folder', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='release_folder', null=True, to=orm['filer.Folder']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Label.folder'
        db.delete_column('alabel_label', 'folder_id')

        # Deleting field 'Release.folder'
        db.delete_column('alabel_release', 'folder_id')
