...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alabel_mediaformat', (
        ...
        db.send_create_signal('alabel', ['Mediaformat'])

        # Adding field 'Release.main_format'
        db.add_column('alabel_release', 'main_format',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alabel.Mediaformat'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'Mediaformat'
        db.delete_table('alabel_mediaformat')

        # Deleting field 'Release.main_format'
        db.delete_column('alabel_release', 'main_format_id')
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2fa40a48-f358-4016-94e9-d9cb85162867'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'327046db-0424-457e-a241-9be4779e0689'", 'max_length': '36'})
        },
        'alabel.media': {
        ...
        'alabel.release': {
            ...
            'main_format': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['alabel.Mediaformat']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
