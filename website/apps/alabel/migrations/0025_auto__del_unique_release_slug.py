...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Release', fields ['slug']
        db.delete_unique('alabel_release', ['slug'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Release', fields ['slug']
        db.create_unique('alabel_release', ['slug'])
