...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alabel_artist_aliases', (
        ...
        db.create_unique('alabel_artist_aliases', ['from_artist_id', 'to_artist_id'])

    def backwards(self, orm):
        # Removing M2M table for field aliases on 'Artist'
        db.delete_table('alabel_artist_aliases')

    models = {
        'alabel.artist': {
            'Meta': {'ordering': "('-priority', 'name')", 'object_name': 'Artist'},
            'aliases': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'aliases_rel_+'", 'null': 'True', 'to': "orm['alabel.Artist']"}),
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4bc20943-9f2e-4585-98bf-7b21235c1216'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'086654af-1418-4a8d-b191-40099d48cceb'", 'max_length': '36'})
        },
        'alabel.media': {
