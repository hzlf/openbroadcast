...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_releaseplugin', (
            ...
            ('release', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['alabel.Release'])),
        ))
        db.send_create_signal('alabel', ['ReleasePlugin'])
    ...
    models = {
        ...
        'alabel.label': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c3d41e2d-011b-4735-83e6-908e4d253c2c'", 'max_length': '36'})
        },
        'alabel.license': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'10608a08-558f-49fb-86cc-0615d9613a81'", 'max_length': '36'})
        },
        'alabel.media': {
