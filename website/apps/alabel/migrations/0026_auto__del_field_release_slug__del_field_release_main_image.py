...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('alabel_release', 'slug', self.gf('django.db.models.fields.SlugField')(default='lalala', max_length=100, db_index=True), keep_default=False)

        # Adding field 'Release.main_image'
        db.add_column('alabel_release', 'main_image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='release_main_image', null=True, to=orm['filer.Image'], blank=True), keep_default=False)
