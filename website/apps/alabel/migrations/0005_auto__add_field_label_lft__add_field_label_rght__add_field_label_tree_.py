...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Label.lft'
        db.add_column('alabel_label', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Label.rght'
        db.add_column('alabel_label', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Label.tree_id'
        db.add_column('alabel_label', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Label.level'
        db.add_column('alabel_label', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Label.lft'
        db.delete_column('alabel_label', 'lft')

        # Deleting field 'Label.rght'
        db.delete_column('alabel_label', 'rght')

        # Deleting field 'Label.tree_id'
        db.delete_column('alabel_label', 'tree_id')

        # Deleting field 'Label.level'
        db.delete_column('alabel_label', 'level')
