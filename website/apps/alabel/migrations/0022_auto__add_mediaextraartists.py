...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alabel_mediaextraartists', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('artist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extraartist_artist', to=orm['alabel.Artist'])),
            ('media', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extraartist_media', to=orm['alabel.Media'])),
            ('profession', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media_extraartist_profession', null=True, to=orm['alabel.Profession'])),
        ))
        db.send_create_signal('alabel', ['MediaExtraartists'])


    def backwards(self, orm):
        
        # Deleting model 'MediaExtraartists'
        db.delete_table('alabel_mediaextraartists')
