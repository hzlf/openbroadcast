...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'ashop.downloadmedia': {
            ...
            'formats': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['alabel.Format']", 'through': "orm['ashop.Mediaformat']", 'symmetrical': 'False'}),
        ...
        'ashop.downloadrelease': {
            ...
            'formats': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['alabel.Format']", 'through': "orm['ashop.Releaseformat']", 'symmetrical': 'False'}),
        ...
        'ashop.mediaformat': {
            ...
            'format': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['alabel.Format']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
